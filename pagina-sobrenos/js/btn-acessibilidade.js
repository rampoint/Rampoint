document.addEventListener("DOMContentLoaded", function () {
  ...
  const changeBackgroundImage = (theme) => {
    const imageElement = document.querySelector(".img-fundo");

    if (imageElement) {
      if (theme === "escuro") {
        imageElement.src = "./img/imagem-fundo-dark.svg"; // Imagem para o modo escuro
      } else {
        imageElement.src = "./img/imagem-fundo.svg"; // Imagem para o modo claro
      }
    }
  };
